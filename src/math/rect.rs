...
use crate::math;
use crate::math::{Point2D, Size, Vector2D, Zero};
...
/// A 2D box. Like a rectangle, but has a minimum and maximum point instead of an origin and size.
